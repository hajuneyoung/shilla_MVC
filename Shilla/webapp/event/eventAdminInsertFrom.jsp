...
<br>
	<form action="../event/eventInsert.do" enctype="multipart/form-data" method="post">
        <div class="container">
            <div align="center">
            	<h4 data-lang="event_thumbnail"></h4>
                <div class="col-lg-4 col-md-6" align="left">
                    <div class="blog-item set-bg" data-setbg="../img/defaultIMG/Ot_default.jpg" id="img_out" >
                    	<br>
    ...
    <section class="blog-details-hero set-bg" id=img_title data-setbg="../img/defaultIMG/t_default.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="bd-hero-text">
                        <span>
                        	<select name="kategorieOnboard">
                        	<!-- ************ 카테고리 정한 후 언어처리 하기 **************** -->
                        ...
                        <ul>
                            ...
                            <li><i class="icon_profile"></i> <textarea class="insert_textarea_from"  name="writerOnboard" rows="1" cols="15" style="width:80%; vertical-align: middle; text-align: center;" required="required" data-lang="manager"></textarea></li>
                        </ul><br><br><br>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-text">
                        <div class="bd-title">
                            <textarea class="insert_textarea_from"  name="prologOnBoard" rows="20" cols="115" style="width:100%" data-lang="add_prologue"></textarea>
                        </div>
                        <div class="bd-pic">
                        	
                            <div class="bp-item">
	                            <label for="imgOne_load">
	                                <img id="imgOne" src="../img/uploadIMG/upLoad.jpg"  alt="">
	                            </label>
                            ...
                            <div class="bp-item">
	                            <label for="imgTwo_load">
	                                <img id="imgTwo" src="../img/uploadIMG/upLoad.jpg"  alt="">
	                            </label>
                            ...
                            <div class="bp-item">
            	                <label for="imgThree_load">
        	                        <img id="imgThree" src="../img/uploadIMG/upLoad.jpg"  alt="">
    	                        </label>
                        ...
                        <div class="bd-more-text">
                            <div class="bm-item">
                                <h4><textarea class="insert_textarea_from" name="subTitleOnBoard" rows="1" cols="71" style="width:100%" data-lang="subtitle"></textarea></h4>
